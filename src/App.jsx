...
/** Gasto avulso (n\u00e3o recorrente) referente a um m\u00eas que j\u00e1 passou \u00e2\u00e2\u201a\u00ac\u00e2\u20ac\u009d considerado resolvido/pago. */
  ...
  return (
    <div className="space-y-5">
      ...
      <button onClick={() => irPara("monitoramento")}
        ...
        <div className="text-sm text-neutral-300 mb-1">Ver onde est\u00e1 indo o dinheiro \u00e2\u00e2\u20ac \u00e2\u20ac\u2122</div>
          ...
          {proximos.map((p) => (
            <div key={rotulo(p.mes)} className="flex-1 flex flex-col items-center justify-end gap-1.5 h-full">
              <div className="text-xs text-neutral-400 whitespace-nowrap">
                {p.total > 0 ? brl(p.total).replace("R$", "").trim() : "\u00e2\u00e2\u201a\u00ac\u00e2\u20ac\u009d"}
              </div>
...
function Monitoramento({ gastos, compras }) {
  ...
  return (
    <div className="space-y-5">
      ...
      <p className="text-xs text-neutral-600">Inclui gastos fixos, vari\u00e1veis e parcelas de cart\u00e3o que caem neste m\u00eas. S\u00f3 muda quando voc\u00ea lan\u00e7a algo \u00e2\u00e2\u201a\u00ac\u00e2\u20ac\u009d nada para ajustar aqui.</p>
    </div>
  );
}
            ...
            <div className="p-4">
              <div className="flex items-start justify-between mb-3">
                ...
                <div className="flex gap-2 text-neutral-500">
                  <button onClick={() => setModalCartao(cartao)} className="hover:text-neutral-200">\u00e2\u00c5\u201c\u017d</button>
              ...
              <div className="grid grid-cols-2 gap-3 mb-3">
                ...
                <div>
                  ...
                  <div className={`text-base font-semibold ${cartao.limite > 0 && cartao.limite - aindaDevo < 0 ? "text-red-400" : "text-neutral-200"}`}>
                    {cartao.limite > 0 ? brl(cartao.limite - aindaDevo) : "\u00e2\u00e2\u201a\u00ac\u00e2\u20ac\u009d"}
                  </div>
                </div>
              </div>
                    ...
                    <div key={c.id} className="px-4 py-3">
                      <div className="flex items-start justify-between gap-3 mb-1.5">
                        ...
                        <div className="flex gap-1.5 shrink-0 text-neutral-500">
                          <button onClick={() => setModalCompra(c)} className="hover:text-neutral-200">\u00e2\u00c5\u201c\u017d</button>
        ...
        <div className="bg-neutral-900 border border-neutral-800 rounded-xl divide-y divide-neutral-800">
          {lista.map((g) => (
            <div key={g.id} className="flex items-center gap-3 px-4 py-3">
              ...
              <button onClick={() => setModal(g)} className="text-neutral-500 hover:text-neutral-200">\u00e2\u00c5\u201c\u017d</button>
        ...
        <div className="bg-neutral-900 border border-neutral-800 rounded-xl divide-y divide-neutral-800">
          {entradas.map((e) => (
            <div key={e.id} className="flex items-center gap-3 px-4 py-3">
              ...
              <button onClick={() => setModal(e)} className="text-neutral-500 hover:text-neutral-200">\u00e2\u00c5\u201c\u017d</button>
